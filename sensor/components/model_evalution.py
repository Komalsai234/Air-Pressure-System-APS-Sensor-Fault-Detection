...
class model_evalution:
    ...
    def initiate_model_evalution(self):
        ...
        logging.info("Prediction on the data using trained and latest model")
        ...
        trained_model_metrics = get_classification_metrics(
            trained_model_pred, data_frame_features)
        latest_model_metrics = get_classification_metrics(
            latest_model_pred, data_frame_features)
